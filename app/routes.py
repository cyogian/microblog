...
from app.forms import LoginForm, RegistrationForm, EditProfileForm, PostForm, ResetPasswordRequestForm, ResetPasswordForm, EmailVerificationForm
...
def user(username):
    ...
    return render_template('user.html', title=username.title(),user=user, posts=posts, currentProfile="active")
...
def follow(username):
    ...
    if user == current_user:
        flash(_("U uh, You can not follow yourself!"))
        return redirect(url_for('index'))
...
def unfollow(username):
    ...
    if user is None:
        ...
        return redirect(url_for('index'))
    if user == current_user:
        flash(_("U uh, You can not unfollow yourself!"))
        return redirect(url_for('index'))
