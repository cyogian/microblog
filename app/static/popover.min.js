!(function(a) {
    ...
    e = function(e, f) {
      return (
        ...
        (this.options.delay.show =
          void 0 === this.options.delay.show ? 0 : this.options.delay.show),
        (this.options.delay.hide =
          void 0 === this.options.delay.hide ? 0 : this.options.delay.hide),
        this.setStyles(),
        this.init(),
        this.initTriggers(),
        this
  ...
  (e.prototype.setStyles = function() {
    if ("default" === this.options.themeName)
      if (a("#fu_popover_styles_default").length);
      else {
        var b =
          ".fu_popover_" +
    ...
    (e.prototype.display = function(b) {
      ...
      if ("show" === b) {
        var d = this.options.delay.show,
          e = this.options.arrowShow;
        if (
          (a("#" + c).length || a("body").append(this.htmlStr),
          setTimeout(function() {
            e ||
              (a("#" + c).attr("class", ""),
              a("#" + c).addClass("fu_popover_" + this.options.themeName)),
              a("#" + c).show();
          }, d),
        ...
        "hide" === b
          ? a("#" + c).hide(this.options.delay.hide)
          : "destroy" === b &&
            (a("#" + c).remove(),
            a(this.element).removeData("fu_popover"),
    ...
    (e.prototype.setPopupPosition = function() {
      ...
      var j,
        k,
        b = this.getOffset(this.element[0]),
        d = (a("#" + this.popoverId).position(), a(this.element).outerWidth()),
        e = a(this.element).outerHeight(),
        f = b.left,
        g = b.top,
        h = a("#" + this.popoverId).outerWidth(),
        i = a("#" + this.popoverId).outerHeight();
      if (
        "bottom" === this.options.placement ||
        "top" === this.options.placement
      ) {
        var l = d / 2,
          m = h / 2;
    ...
    (e.prototype.destroyTriggers = function() {
      ...
      for (var c = 0; c < b.length; c++)
        a("body").off("click", "#" + this.element[0].id, function() {}),
